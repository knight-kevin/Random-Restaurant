...
```text
https://knight-kevin.github.io/Random-Restaurant/modern.html?v=20260630-v49
```
...
`v49` 恢复高德式轻量筛选条：位置、分类、排序、扫街榜、附近 3 公里；顶部快速分类增加小缩略图。分类规则升级为“主分类 + 多标签”，模糊餐厅可同时命中多个分类，例如海鲜面可同时出现在鱼鲜海鲜和面食米粉里，奶茶咖啡品牌不再被泛化类型误分到快餐。
